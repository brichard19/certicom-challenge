...
typedef void* uint131_vec_ptr_t;
...
extern "C" __global__ void do_step_p79(uint131_vec_ptr_t global_px, uint131_vec_ptr_t global_py, uint131_vec_ptr_t global_rx, uint131_vec_ptr_t global_ry, uint131_vec_ptr_t mbuf, int count, DPResult* result, int* result_count,
  StagingPoint* staging, int* staging_count, uint131_t* priv_key_a, uint64_t counter, uint64_t* start_pos, uint64_t dpmask);

extern "C" __global__ void do_step_p131(uint131_vec_ptr_t global_px, uint131_vec_ptr_t global_py, uint131_vec_ptr_t global_rx, uint131_vec_ptr_t global_ry, uint131_vec_ptr_t mbuf, int count, DPResult* result, int* result_count,
  StagingPoint* staging, int* staging_count, uint131_t* priv_key_a, uint64_t counter, uint64_t* start_pos, uint64_t dpmask);

extern "C" __global__ void check_for_dp(uint131_vec_ptr_t global_px, uint131_vec_ptr_t global_py, int count, DPResult* result, int* result_count,
  StagingPoint* staging, int* staging_count, uint131_t* priv_key_a, uint64_t counter, uint64_t* start_pos, uint64_t dpmask);
