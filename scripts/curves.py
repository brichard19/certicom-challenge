...
ecp79 = CurveParams(
    p = int('62CE5177412ACA899CF5', 16),
    a = int('39C95E6DDDB1BC45733C', 16),
    b = int('1F16D880E89D5A1C0ED1', 16),

    n = int('62CE5177407B7258DC31', 16),
...
def getCurveByName(curveName):
    ...
    return ECCurve(curve.a, curve.b, curve.p, curve.n, curve.x, curve.y, curveName)
