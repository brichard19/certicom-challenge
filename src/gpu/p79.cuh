...
template <> struct Curve<CURVE_ID_ECP79> {
...
__device__ uint131_t Curve<CURVE_ID_ECP79>::sub(uint131_t x, uint131_t y)
{
  uint131_t z = {{0}};
...
__device__ uint131_t Curve<CURVE_ID_ECP79>::add(uint131_t x, uint131_t y)
{
...
__device__ uint131_t Curve<CURVE_ID_ECP79>::mul(uint131_t a, uint131_t b)
{
