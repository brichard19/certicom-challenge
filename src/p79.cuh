...
__device__ uint131_t Curve<79>::high_bits(uint262_t x)
{
  uint131_t hi;
...
__device__ uint262_t Curve<79>::mul(uint131_t a, uint131_t b)
{
  uint262_t tmp;
  uint64_t high = 0;
...
__device__ uint131_t Curve<79>::mul_shift_160(uint160_t a, uint131_t b)
{
  uint64_t tmp[5];
  uint64_t high = 0;
